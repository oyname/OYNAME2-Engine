...
void GDXECSRenderer::AppendDebugBounds(RenderQueue& queue, const VisibleRenderCandidate& candidate, MaterialHandle material, float alpha, const FrameData& debugFrame, RFG::ViewStats* viewStats)
{
...
void GDXECSRenderer::AppendDebugFrustum(RenderQueue& queue, const RenderViewData& view, MaterialHandle material, float alpha, const FrameData& debugFrame, RFG::ViewStats* viewStats)
{
...
void GDXECSRenderer::AppendDebugVisibleSet(RenderQueue& queue, const VisibleSet& set, const RenderViewData& view, RFG::ViewStats* viewStats)
{
...
void GDXECSRenderer::EndFrame()
{
    ...
    m_systemScheduler.AddTask({ "Execute Frame Graph",
        ...
        [this]()
        {
            GDXRenderFrameGraph::ExecContext ectx{};
