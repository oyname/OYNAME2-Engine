...
private:
    ...
    void AppendDebugVisibleSet(RenderQueue& queue, const VisibleSet& set, const RenderViewData& view, RFG::ViewStats* viewStats = nullptr);
    void AppendDebugBounds(RenderQueue& queue, const VisibleRenderCandidate& candidate, MaterialHandle material, float alpha, const FrameData& debugFrame, RFG::ViewStats* viewStats = nullptr);
    void AppendDebugFrustum(RenderQueue& queue, const RenderViewData& view, MaterialHandle material, float alpha, const FrameData& debugFrame, RFG::ViewStats* viewStats = nullptr);
